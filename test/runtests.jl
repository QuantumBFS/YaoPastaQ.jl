...
@testset "YaoPastaQ.jl" begin
    ...
    @test PastaQReg(3) isa PastaQReg{PastaQ.MPS}
    @test measure(PastaQReg(3)) isa PastaQReg{PastaQ.MPS}
    @test apply!(PastaQReg(3), chain(3, put(1=>X))) isa PastaQReg{PastaQ.MPS}
end
